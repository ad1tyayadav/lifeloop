      ...
      <div className="relative bg-gradient-to-b from-white to-[#bff5cf] py-24">
        <div className="max-w-7xl mx-auto px-6 text-center relative">
          <p className="mb-20 text-gray-800 text-lg italic font-medium">
            Built for the Predictable Future.
          </p>
          {/* Content Container */}
          <div className="relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed whitespace-pre-line">
                LIFELOOP exists to turn complexity into clarity — and uncertainty into advantage.
                We engineer predictive ecosystems where data, intuition, and foresight converge into one living intelligence.
                Every model we build empowers leaders to see the ripple before it hits — translating AI foresight into decisions powered by confidence, control, and calm.
              </p>
            </div>
